...
function CustomMap({ timeRange }) {
  ...
  return (
    <div className="map">
      ...
      >
        Number of messages: {tooltip.totalMessages}
      </MapToolTip>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 400">
        <path
          className={tooltip.id === 'palacehills' ? 'active' : ''}
          ...
          id="map_palacehills"
          style={mapInfo.palacehills.style}
          onClick={(e) =>
            setTooltip({
              title: 'Palace Hills',
              id: 'palacehills',
              ...
              visible: true,
              totalMessages: mapInfo.northwest.text,
            })
          }
        ></path>
        <path
          className={tooltip.id === 'northwest' ? 'active' : ''}
        ...
        ></path>
        <path
          className={tooltip.id === 'oldtown' ? 'active' : ''}
          ...
          onClick={(e) =>
            setTooltip({
              ...
              visible: true,
              totalMessages: mapInfo.oldtown.text,
            })
          }
        ></path>
        <path
          className={tooltip.id === 'safetown' ? 'active' : ''}
          ...
          onClick={(e) =>
            setTooltip({
              ...
              visible: true,
              totalMessages: mapInfo.safetown.text,
            })
          }
        ></path>
        <path
          className={tooltip.id === 'southwest' ? 'active' : ''}
          ...
          onClick={(e) =>
            setTooltip({
              ...
              visible: true,
              totalMessages: mapInfo.southwest.text,
            })
          }
        ></path>
        <path
          className={tooltip.id === 'downtown' ? 'active' : ''}
          ...
          onClick={(e) =>
            setTooltip({
              ...
              visible: true,
              totalMessages: mapInfo.downtown.text,
            })
          }
        ></path>
        <path
          className={tooltip.id === 'wilsonforest' ? 'active' : ''}
          ...
          id="map_wilsonforest"
          style={mapInfo.wilsonforest.style}
          onClick={(e) =>
            setTooltip({
              title: 'Wilson Forest',
              id: 'wilsonforest',
              ...
              visible: true,
              totalMessages: mapInfo.wilsonforest.text,
            })
          }
        ></path>
        <path
          className={tooltip.id === 'scenicvista' ? 'active' : ''}
          ...
          id="map_scenicvista"
          style={mapInfo.scenicvista.style}
          onClick={(e) =>
            setTooltip({
              title: 'Scenic Vista',
              id: 'scenicvista',
              ...
              visible: true,
              totalMessages: mapInfo.scenicvista.text,
            })
          }
        ></path>
        <path
          className={tooltip.id === 'broadview' ? 'active' : ''}
          ...
          onClick={(e) =>
            setTooltip({
              ...
              visible: true,
              totalMessages: mapInfo.broadview.text,
            })
          }
        ></path>
        <path
          className={tooltip.id === 'chapparal' ? 'active' : ''}
          ...
          onClick={(e) =>
            setTooltip({
              ...
              visible: true,
              totalMessages: mapInfo.chapparal.text,
            })
          }
        ></path>
        <path
          className={tooltip.id === 'terrapinsprings' ? 'active' : ''}
          ...
          style={mapInfo.terrapinsprings.style}
          onClick={(e) =>
            setTooltip({
              title: 'Terrapin Springs',
              id: 'terrapinsprings',
              position: {
                left: e.nativeEvent.x,
                top: e.nativeEvent.y,
              ...
              visible: true,
              totalMessages: mapInfo.terrapinsprings.text,
            })
          }
        ></path>
        <path
          className={tooltip.id === 'peppermill' ? 'active' : ''}
          ...
          id="map_peppermill"
          style={mapInfo.peppermill.style}
          onClick={(e) =>
            setTooltip({
              title: 'Pepper Mill',
              id: 'peppermill',
              ...
              visible: true,
              totalMessages: mapInfo.peppermill.text,
            })
          }
        ></path>
        <path
          className={tooltip.id === 'cheddarford' ? 'active' : ''}
          ...
          id="map_cheddarford"
          style={mapInfo.cheddarford.style}
          onClick={(e) =>
            setTooltip({
              title: 'Cheddarford',
              id: 'cheddarford',
              ...
              visible: true,
              totalMessages: mapInfo.cheddarford.text,
            })
          }
        ></path>
        <path
          className={tooltip.id === 'easton' ? 'active' : ''}
          ...
          onClick={(e) =>
            setTooltip({
              ...
              visible: true,
              totalMessages: mapInfo.easton.text,
            })
          }
        ></path>
        <path
          className={tooltip.id === 'weston' ? 'active' : ''}
          ...
          onClick={(e) =>
            setTooltip({
              ...
              visible: true,
              totalMessages: mapInfo.weston.text,
            })
          }
        ></path>
        <path
          className={tooltip.id === 'southton' ? 'active' : ''}
          ...
          onClick={(e) =>
            setTooltip({
              ...
              visible: true,
              totalMessages: mapInfo.southton.text,
            })
          }
        ></path>
        <path
          className={tooltip.id === 'oakwillow' ? 'active' : ''}
          ...
          onClick={(e) =>
            setTooltip({
              ...
              visible: true,
              totalMessages: mapInfo.oakwillow.text,
            })
          }
        ></path>
        <path
          className={tooltip.id === 'eastparton' ? 'active' : ''}
          ...
          id="map_eastparton"
          style={mapInfo.eastparton.style}
          onClick={(e) =>
            setTooltip({
              title: 'East Parton',
              id: 'eastparton',
              ...
              visible: true,
              totalMessages: mapInfo.eastparton.text,
            })
          }
        ></path>
        <path
          className={tooltip.id === 'westparton' ? 'active' : ''}
          ...
          id="map_westparton"
          style={mapInfo.westparton.style}
          onClick={(e) =>
            setTooltip({
              title: 'West Parton',
              id: 'westparton',
              ...
              visible: true,
              totalMessages: mapInfo.westparton.text,
            })
          }
        ></path>
